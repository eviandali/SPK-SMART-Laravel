    ...
    <div class="container-xl">
        <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
            ...
            $sortedAlternatifs = $alternatifs->sortByDesc(function ($alternatif) {
                return $alternatif->pembobotan->sum('perkalian_bobot');
            });
        @endphp
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    ...
                    <div class="row gx-5 gy-3">
                        ...
                        <div class="col-12 col-lg-9">
                            ...
                            <div>Berdasarkan Perhitungan yang di lakukan <strong>  {{ $alternatifs[0]->nama_doi }} </strong> memiliki nilai tertinggi silahkan klik tombol di samping untuk lebih detail</div>
                        </div><!--//col-->
                        <div class="col-12 col-lg-3">
                            <a class="btn app-btn-primary" href="{{ route('detailHasil', $alternatifs[0]->id) }}">{{ $alternatifs[0]->nama_doi }}</a>
                        </div><!--//col-->
                    </div><!--//row-->
                ...
                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    ...
                    <div class="app-card-body px-4 w-100">
                        ...
                        @if ($alternatif->pembobotan->isNotEmpty())
                            ...
                            <a href=""  class="btn app-btn-primary">CETAK Hasil</a>
                            <a class="btn app-btn-secondary" href="{{ route('alternatif.show', $alternatif->id) }}">{{ $alternatif->nama_doi }}</a>
