                ...
                <div class="app-card-body">
                    ...
                    <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <form method="POST" action="{{ route('pembobotan.update', $alternatifs->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                @foreach ($pembobotans as $pembobotan)
                                    <div class="form-group">
                                        <label for="bobot_kriteria{{ $pembobotan->id }}">{{ $pembobotan->criteria }}</label>
                                        <input type="number" class="form-control" id="bobot_kriteria{{ $pembobotan->id }}" name="bobot_kriteria[]" value="{{ $pembobotan->bobot_kriteria }}" required>
                                        <input type="hidden" name="kriteria_id[]" value="{{ $pembobotan->kriteria_id }}">
                                    </div>
                                @endforeach
