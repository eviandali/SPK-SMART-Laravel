    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Seleksi ayang adalah sebuah Sistem Pendukung Keputusan dengan metode SMART</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">semua ini dibuat untuk anda yang bingung menyeleksi ayang anda</h2>
